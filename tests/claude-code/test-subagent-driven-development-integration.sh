...
mkdir -p src test docs/text2prod/plans

# Create a simple implementation plan
cat > docs/text2prod/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/text2prod/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/text2prod/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"text2prod:subagent-driven-development"' "$SESSION_FILE"; then
