...
<!-- Text2Prod core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `using-text2prod` bootstrap at session
...
- [ ] If this is a skills change: I used `text2prod:writing-skills` and
